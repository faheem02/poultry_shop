...
<head>
    ...
    <style>
        ...
        .print-header { display: none; text-align: center; border-bottom: 2px solid #059669; padding-bottom: 10px; margin-bottom: 15px; }
        .print-header h3 { margin: 0; font-weight: 700; color: #059669; font-size: 1.4rem; }
        .print-header p { margin: 3px 0 0; font-size: 0.85rem; color: #555; }
    ...
    <div id="content-wrapper" class="d-flex flex-column">
        <div id="content">
            ...
            <div class="print-header">
                <h3>AL FAISAL POULTRY</h3>
                <p>City Sahiwal &nbsp;|&nbsp; Phone: 0311-0756747</p>
            </div>
<?php
$flash = flashMessage();
if ($flash):
