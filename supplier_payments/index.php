...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    ...
    header('Location: /poultry_shop/supplier_payments/index.php');
    exit;
}
...
<div class="card mb-4 border-start-info">
    <div class="card-body">
        <form method="GET" class="row g-2 align-items-end">
            ...
            <?php if ($filter_date): ?>
            <div class="col-auto">
                <a href="/poultry_shop/supplier_payments/index.php" class="btn btn-secondary btn-sm"><i class="fas fa-times me-1"></i> Clear</a>
            </div>
            <?php endif; ?>
        </form>
    </div>
