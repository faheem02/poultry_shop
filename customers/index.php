...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_POST['action'])) {
    ...
    header('Location: /poultry_shop/customers/index.php');
    exit;
}
...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <a href="/poultry_shop/customers/create.php" class="btn btn-primary btn-sm">
            ...
            <table class="table datatable table-hover mb-0 small">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a href="/poultry_shop/customers/ledger.php?id=<?= $c['id'] ?>" class="btn btn-sm btn-outline-info" title="Ledger">
