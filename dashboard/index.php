...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div>
        ...
        <a href="/poultry_shop/chicken_rates/index.php" class="btn btn-success btn-sm">
            ...
            <table class="table table-hover mb-0 small">
                ...
                <tbody>
                    <?php if (count($recent_sales)): ?>
                        ...
                        <tr>
                            <td><a href="/poultry_shop/sales/view.php?id=<?= $sale['id'] ?>"><?= htmlspecialchars($sale['invoice_no']) ?></a></td>
                            ...
                            <td><a href="/poultry_shop/sales/invoice.php?id=<?= $sale['id'] ?>" class="btn btn-sm btn-outline-primary" target="_blank"><i class="fas fa-print"></i></a></td>
                        </tr>
                        <?php endforeach; ?>
                    <?php else: ?>
