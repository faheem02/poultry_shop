                ...
                <form id="saleForm">
                    ...
                    <div class="row g-3">
                        ...
                        <div class="">
                            ...
                            <input type="hidden" name="birds_count" id="birds_count" class="form-control form-control-lg" min="0" step="1" placeholder="0">
                        </div>
            ...
            <div class="card-body py-3">
                <div class="row text-center">
                    <div class="">
                        ...
                        <div style="display:none;" class="h5 mb-0 fw-bold" id="display_birds">0</div>
                    </div>
                    <div class="col-4">
