...
$balance = $opening_balance + $total_purchases - $total_payments;
        ...
        <div class="table-responsive">
            <table class="table table-hover mb-0 small">
                ...
                <tbody>
                    ...
                    ?>
                    <tr class="<?= $e['type'] === 'opening' ? 'table-info' : ($e['type'] === 'payment' ? 'table-success' : '') ?>">
                        <td>
                            <?php if ($e['date'] === '0000-00-00'): ?>
                        ...
                        <td>
                            ...
                            <?php elseif ($e['type'] === 'purchase'): ?>
                            <i class="fas fa-shopping-cart text-danger me-1"></i>
