...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    ...
    <div>
        <a href="/poultry_shop/sales/invoice.php?id=<?= $sale['id'] ?>" class="btn btn-primary btn-sm" target="_blank">
            <i class="fas fa-print me-1"></i> Print Invoice
        </a>
        <a href="/poultry_shop/sales/index.php" class="btn btn-outline-secondary btn-sm">
