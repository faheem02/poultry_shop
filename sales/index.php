    ...
    <div>
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb small mb-0">
                <li class="breadcrumb-item"><a href="/poultry_shop/dashboard/index.php" class="text-decoration-none">Dashboard</a></li>
                <li class="breadcrumb-item active" aria-current="page">Sales</li>
            </ol>
        </nav>
    </div>
    <a href="/poultry_shop/pos/index.php" class="btn btn-primary btn-sm shadow-sm">
...
<div class="card shadow-sm border-0">
    <div class="card-header bg-transparent py-3 d-flex flex-wrap align-items-center justify-content-between">
        ...
        <div>
            <button class="btn btn-sm btn-outline-success me-1" onclick="window.print()">
